import { Currency, CurrencyAmount, Fraction, Percent } from '@crystals/sdk'
  ...
  return (
    <>
      ...
      <RowBetween>
        ...
        <Body>{noLiquidity !== false ? '100' : poolTokenPercentage?.toSignificant(4)}%</Body>
      </RowBetween>
      <Button mt="20px" onClick={onAdd}>
        {noLiquidity !== false ? 'Create Pool & Supply' : 'Confirm Supply'}
      </Button>
    </>
  )
}
